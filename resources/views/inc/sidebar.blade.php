<div class="sidebar">
    <div class="sidebar-inner">
      ...
      <ul class="sidebar-menu scrollable pos-r">
        ...
        @can('listDrafts', \App\Article::class)        
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a href="/articles/drafts">Drafts</a>
              </li>
            </ul>
          </li>
        @else 
          <li class="nav-item">
            <a class="sidebar-link" href="/articles">
              <span class="icon-holder">
                <i class="c-brown-500 ti-write"></i>
              </span>
              <span class="title">Articles</span>
            </a>
          </li>
        ...
        @can('list', \App\Song::class)
          <li class="nav-item">
            <a class="sidebar-link" href="/songs">
              <span class="icon-holder">
                <i class="c-deep-orange-500 ti-music"></i>
              </span>
