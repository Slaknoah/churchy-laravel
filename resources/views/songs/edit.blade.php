            ...
            @if($song) 
                <div class="bgc-white p-20 bd">
                    ...
                    <div class="mT-30 clearfix">
                        {{ Form::open(array('action' => ['SongController@update', $song->id], 'method' => 'POST', 'enctype' => 'multipart/form-data')) }}
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    {{ Form::text( 'artist', $song->artist, ['class' => 'form-control', 'placeholder' => 'Song artist']) }}
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="inputTempo">Tempo</label>
                                    {{ Form::number( 'tempo', $song->tempo, ['class' => 'form-control', 'placeholder' => 'Tempo(bpm)']) }}
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    {{Form::textarea('chord', $song->chord, ['class' => 'form-control', 'placeholder' => 'Song chord', 'cols' => '30', 'rows' => '10'])}}
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="inputContent">Lyrics</label>
                                    {{Form::textarea('lyrics', $song->lyrics, ['class' => 'form-control', 'placeholder' => 'Song lyrics', 'cols' => '30', 'rows' => '20'])}}
                                </div>
                            </div>
